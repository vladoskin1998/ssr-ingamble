                        ...
                        <div className="main-privacy-policy__body">
                            <div className="main-privacy-policy__item">
                                <p>
                                    ...
                                    This Privacy Policy outlines how we collect, use, disclose, and protect the information you provide to
                                    us when you visit our website.
                                </p>
                                <p>
                                    We reserve the right to change this Privacy Policy at any given time, of which you will be promptly
                                ...
                                <ul className="main-privacy-policy__list">
                                    <li className="main-privacy-policy__list-item">
                                        ...
                                        <ul className="main-privacy-policy__sublist">
                                            ...
                                            <li className="main-privacy-policy__sublist-item">
                                                Bank account information for payment of products and/or services under the Service;
                                            </li>
                                    ...
                                    <li className="main-privacy-policy__list-item">
                                        <span>
                                            When you pay for a product and/or service by wire transfer, we may ask you to provide
                                            information to facilitate the transaction and verify your identity. Such information may
                                    ...
                                    <li className="main-privacy-policy__list-item">
                                        <span>
                                            Usage Information: We may collect information about how you use our website, including your IP
                                            address, browser type, referring/exit pages, and operating system.
                                        </span>
                                    </li>
                                    <li className="main-privacy-policy__list-item">
                                        <span>
                                            Cookies: We use cookies and similar technologies to improve your browsing experience and collect
                                            information about your preferences. Please see our{' '}
                            ...
                            <div className="main-privacy-policy__item">
                                ...
                                <ul className="main-privacy-policy__list main-privacy-policy__list_small">
                                    <li className="main-privacy-policy__list-item">
                                        <span>
                                            To provide and maintain our services, including processing transactions and providing customer
                                            support.
                                        </span>
                                    </li>
                                    <li className="main-privacy-policy__list-item">
                                        <span>
                                            To personalize your experience and deliver content and product offerings relevant to your
                                            interests.
                                        </span>
                                    </li>
                                    <li className="main-privacy-policy__list-item">
                                        <span>
                                            To communicate with you about your account, updates to our services, and promotional offers.
                                        </span>
                                    </li>
                                    <li className="main-privacy-policy__list-item">
                            ...
                            <div className="main-privacy-policy__item">
                                ...
                                <p>
                                    ...
                                    website and conducting our business. These service providers are obligated to keep your information
                                    confidential and are prohibited from using it for any other purpose.
                                </p>
                                <p>
                                    We may also disclose your personal information if required to do so by law or in the good-faith belief
                                    that such action is necessary to comply with legal obligations, protect and defend our rights or
                            ...
                            <div className="main-privacy-policy__item">
                                ...
                                <span>
                                    For users residing in the European Economic Area (EEA), we comply with the General Data Protection
                                    Regulation (GDPR). Under the GDPR, you have the following rights:
                                </span>
                                ...
                                <p>
                                    ...
                                    Us&quot; section below. We will respond to your request within 30 days.
                                </p>
                            </div>
                            <div className="main-privacy-policy__item">
                                ...
                                <p>
                                    By using our website, you consent to the collection, use, and disclosure of your information as
