...
import FilterBonus from './FilterBonus'
...
async function getCategoryName(slug: string | undefined): Promise<string | null> {
    try {
        ...
        const category = response.data.bonus_categories.find(cat => cat.slug === slug)
